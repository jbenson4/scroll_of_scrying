...
const TableRow = (props) => {
  return (
    <Fragment>
      {props.category.index === 'magic-items' && <li className='row-item'>You stumble upon the coveted <strong onClick={props.getDetails} id={'magic-items'}>{props.name}</strong>!</li>}
